Feature: Forgot the password professor
    ...
    Scenario: Clicking forgot password
        When I fill the "E-mail" field with "devil@usp.br"
    ...
    Scenario: Clicking forgot password with wrong email
        When I fill the "E-mail" field with "devi@usp.br"
        And I press the "Enviar o email com instruções para obter nova senha" button
        Then I should see "Não foi possível salvar user: 1 erro"
        And I should see "E-mail não encontrado"

    Scenario: Clicking forgot password with empty email
        When I fill the "E-mail" field with ""
        And I press the "Enviar o email com instruções para obter nova senha" button
        Then I should see "Não foi possível salvar user: 1 erro"
        And I should see "E-mail não pode ficar em branco"
