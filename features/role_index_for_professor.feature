Feature: Assistant roles table visualization
    ...
    Scenario: Professor sees the correct frequencies
        ...
        And I'm logged in as professor "Gold"
        And I visit my assistant roles page
        Then I should see "John Monitor de MAC0431 Março: --- Abril: Ausente Maio: --- Junho: ---"
        Then I should see "Wil Monitor de MAC0431 Março: Presente Abril: Presente Maio: --- Junho: ---"
        Then I should see "Alfredo Monitor de MAC0431 Desativado"
    ...
    Scenario: Professor marks frequency
        ...
        Then I should see "John Monitor de MAC0431 Março: --- Abril: Ausente Maio: Presente Junho: ---"
        And I should see "Wil Monitor de MAC0431 Março: Presente Abril: Presente Maio: Junho: ---"
        And I should see "Alfredo Monitor de MAC0431 Desativado"
        And I press the first "Ausente" button
        And I should see "John Monitor de MAC0431 Março: --- Abril: Ausente Maio: Presente Junho: ---"
        And I should see "Wil Monitor de MAC0431 Março: Presente Abril: Presente Maio: Ausente Junho: ---"
        And I should see "Alfredo Monitor de MAC0431 Desativado"
