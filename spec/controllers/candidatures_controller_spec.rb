...
describe CandidaturesController do
  ...
  describe ".index" do
    context 'as student' do
      ...
      it { expect(response).to redirect_to action: :index_for_student, student_id: student }
    end
    context 'as super professor' do
      ...
      it { expect(response).to redirect_to action: :index_for_department, semester_id: semester.id, department_id: super_professor.department }
    end
  ...
  describe "GET new" do
    it "assigns a new candidature as @candidature" do
      ...
      it { 
        ...
        expect(assigns(:semester)).to eq(42)
      }
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      ...
      it "redirects to the created candidature" do
        post :create, {:candidature => valid_attributes}, valid_session
        it { expect(response).to redirect_to(Candidature.last) }
      end
    end
  ...
  describe "PUT update" do
    describe "with valid params" do
      ...
      it "updates the requested candidature" do
        ...
        it { expect(Candidature.any_instance).to receive(:update).with({ "daytime_availability" => "false" }).and_return(true) }
      ...
      it "redirects to the candidature" do
        put :update, {:id => @candidature.to_param, :candidature => valid_attributes}, valid_session
        it { expect(response).to redirect_to(@candidature) }
      end
    end
  ...
  describe "DELETE destroy" do
    ...
    it "redirects to the candidatures list" do
      delete :destroy, {:id => @candidature.to_param}, valid_session
      it { expect(response).to redirect_to(candidatures_url) }
    end
  end
