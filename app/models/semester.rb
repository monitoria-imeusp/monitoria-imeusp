class Semester < ActiveRecord::Base
  ...
  def open_frequency_month which
    open_frequency_period(Semester.month_to_period which)
  end

  def close_frequency_month which
    close_frequency_period(Semester.month_to_period which)
  end
